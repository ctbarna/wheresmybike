...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Station.lasest_update_time'
        db.delete_column(u'finder_station', 'lasest_update_time')

        # Adding field 'Station.last_updated'
        db.add_column(u'finder_station', 'last_updated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Station.lasest_update_time'
        db.add_column(u'finder_station', 'lasest_update_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Deleting field 'Station.last_updated'
        db.delete_column(u'finder_station', 'last_updated')
